...
mod m20260202_000014_create_librarys_related_tags_table;
...
mod m20260216_000001_insert_roles_and_permisions;
...
impl MigratorTrait for Migrator {
  fn migrations() -> Vec<Box<dyn MigrationTrait>> {
    vec![
      ...
      Box::new(m20260202_000014_create_librarys_related_tags_table::Migration),
      ...
      Box::new(m20260216_000001_insert_roles_and_permisions::Migration),
    ]
  }
}
